  ...
  return (
    <div className='sobreMi-contenedor'>
        <div className='sobreMi-datos'>
            <h1 className='sobreMi-titulo'><span>¿</span>Quien soy<span>?</span></h1>
            ...
            <h1 className='sobreMi-titulo'><span>¿</span>Cómo me considero<span>?</span></h1>
            <p className='sobreMi-info'>
        ...
        <h1 className='sobreMi-titulo'><span>¿</span>Dónde vivo<span>?</span></h1>
